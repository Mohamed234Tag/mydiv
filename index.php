...
<head>
  ...
  <meta name="description" content="Fullstack website creation service using the latest tools and we provide some free themes. You can now start building your own business website.">
  <meta name="keywords" content="Full Stack, Frontend, Make A Great website, Free themes, برمجة مواقع, ويب, شراء مواقع الكترونية, ويب, برمجة, شراء, بيع, منتجات, فريق عمل, بيزنس">
    <meta name="author" content="Mohamed TagEldin">
</head>
...
<section class="fixed-top navigation">
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="index.php"><img src="snapedit_1706041725549-removebg-preview.png" alt="logo" style="width:90px; height:auto;"></a>
      ...
      <div class="collapse navbar-collapse text-center" id="navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://mostaql.com/project/create?freelancer=Mohamed_h_tag">Message</a>
          </li>
        </ul>
        <a href="https://mostaql.com/u/Mohamed_h_tag" class="btn btn-primary ml-lg-3 primary-shadow">See pruducts</a>
      </div>
    </nav>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center zindex-1">
        <h1 class="mb-3">Start make a your great Busines.</h1>
        <p class="mb-4">
        Start making your website. God willing, it will be beautiful,
         as this expresses the  <br> quality of your service.</p>
        <a href="https://mostaql.com/project/create?freelancer=Mohamed_h_tag" class="btn btn-secondary btn-lg">Start make your website</a>
        <!-- banner image -->
        <img class="img-fluid w-100 banner-image" style="height: auto;" src="images/hero-area/banner-img.png" alt="banner-img">
      </div>
    </div>
  </div>
  <!-- background shapes -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <p class="mb-100">You can learn some information about us and the features available.<p>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          ...
          <div>
            ...
            <p>We will make a lot of designs to show you first.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          ...
          <div>
            ...
            <p>We will customize everything you want and solve any problems you encounter.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          ...
          <div>
            <h4>A great code</h4>
            <p>A responsive and a easy devalnmpnt code.</p>
          </div>
        </div>
      </div>
      <!-- feature item -->
...
<section class="section-lg seo">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5">
        <h2 class="section-title">A large collection of free sites!</h2>
        <p>A group of frontend sites, most of which are not free. When you buy <br> them, you are free to use them whenever you want..
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-md-5 order-2 order-md-1">
        ...
        <p class="mb-4">Whatever the idea for your site, we will make it happen for you. For example, there are sites that rely on scroll, and there are sites that rely on animation when the page loads....</p>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-1">
              <h3>Free</h3>
              <h1><span>$</span>00</h1>
              <p>Free frontend websites and templates
              </p>
              <a href="https://dribbble.com/tags/free-theme" class="btn pricing-btn px-2">Get Started</a>
            </div>
          </div>
          <!-- pricing table -->
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-2">
              ...
              <h1><span>$</span>150</h1>
              <p>Create websites with one category
              </p>
              <a href="https://mostaql.com/project/create?freelancer=Mohamed_h_tag" class="btn pricing-btn px-2">Buy Now</a>
            </div>
          </div>
          <!-- pricing table -->
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
            <div class="rounded text-center pricing-table table-3">
              <h3>Fullstack</h3>
              <h1><span>$</span>250</h1>
              <p>Create full stack websites that are integrated in all aspects, such as stores
              </p>
              <a href="https://mostaql.com/project/create?freelancer=Mohamed_h_tag" class="btn pricing-btn px-2">Buy Now</a>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <p class="mb-5">Creat your website...</p>
      </div>
      <div class="col-lg-8 col-sm-10 col-12 mx-auto">
        <form action="https://mostaql.com/project/create?freelancer=Mohamed_h_tag">
          <div class="input-wrapper position-relative">
            <input type="email" class="newsletter-form" id="newsletter" placeholder="Enter your email">
            <button type="submit" value="send" class="btn newsletter-btn">Send</button>
          </div>
        </form>
      </div>
    </div>
